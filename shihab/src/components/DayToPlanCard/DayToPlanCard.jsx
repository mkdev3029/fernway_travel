...
const DayToPlanCard = () => {
    return (
        <div className='plan-card'>
           <img className='plan-Card-img' src="https://media.istockphoto.com/photos/kilchurn-sunset-picture-id622204296?k=20&m=622204296&s=612x612&w=0&h=7BDyJBiUqwjk2-GmdJgCJf7Xz9ZD4BgoXirJKyQdDTs=" alt="" />
            <div className="flex">
