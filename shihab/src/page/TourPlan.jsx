...
// setList([...data])
    useEffect(() => {
        axios.get("http://localhost:3004/includedAttraction", {
            params: {
...
//    setHotelList([...data])
        axios.get("http://localhost:3004/includedActivities", {
            params: {
                location: para.locations ,     //mention location here
            }
        }).then(({ data }) => {
        ...
        axios.get("http://localhost:3004/includedLivePlace", {
            params: {
                location: para.locations ,     //mention location here
            }
        }).then(({ data }) => {
    ...
    return (
        <>
            <Link to={`/tourplan/:locations/dayplan/${para.locations}`}>
