    ...
    <>
      <div className="nav-bar">
        <button
          ...
          value="home"
          className={`nav-items ${isActive["home"] ? "active" : ""}`}
        >
          <svg
            width="32"
            height="32"
        ...
        <button
          onClick={handleToggle}
          value="clipboard"
          className={`nav-items ${isActive["clipboard"] ? "active" : ""}`}
        >
          <svg
            width="32"
            height="32"
        ...
        <button
          onClick={handleToggle}
          value="farney"
          className={`nav-items ${isActive["farney"] ? "active" : ""}`}
        >
          <svg
            width="32"
            height="32"
        ...
        <button
          onClick={handleToggle}
          value="profile"
          className={`nav-items ${isActive["profile"] ? "active" : ""}`}
        >
          <svg
            width="32"
            height="32"
